...
export const Patterns = {
  linkPattern: /^$|^https?:\/\//,
  NamePattern: /^[ґҐіІєЄїЇА-Яа-яa-zA-ZäöüßÄÖÜ](?!.*\.$)(?!.*?\.\.)(?!.*?--)(?!.*?'')[-'ʼ’ ґҐіІєЄїЇА-Яа-яa-zA-Z0-9äöüßÄÖÜ.]{0,29}$/,
  LongNamePattern: /^[ґҐіІєЄїЇА-Яа-яa-zA-Z](?!.*\.$)(?!.*?\.\.)(?!.*?--)(?!.*?'')[-'ʼ’ ґҐіІєЄїЇА-Яа-яa-zA-Z0-9äöüßÄÖÜ.]{0,39}$/,
  ServiceNamePattern: /^[ґҐіІєЄїЇА-Яа-яa-zA-Z0-9!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~\s]{1,30}$/,
  TarifNamePattern: /^[ґҐіІєЄїЇА-Яа-яa-zA-Z](?!.*\.$)(?!.*?\.\.)(?!.*?)(?!.*?)[-'ʼ’ ґҐіІєЄїЇА-Яа-яa-zA-Z0-9äöüßÄÖÜ.]{0,255}$/,
