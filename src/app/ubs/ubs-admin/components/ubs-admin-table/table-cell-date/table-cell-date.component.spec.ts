...
describe('TableCellDateComponent', () => {
  ...
  describe('TableCellDateComponent and its methods testing ', () => {
    ...
    it('Test if edit() calls blockOrders() from AdminTableService with []', inject([AdminTableService], (service: AdminTableService) => {
    ...
    it('Test if edit() calls blockOrders() from AdminTableService with ordersToChange', inject(
      [AdminTableService],
    ...
    it('Test if edit() calls blockOrders() from AdminTableService with [this.id]', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        spyOn(service, 'blockOrders').and.returnValue(of(iAlertInfo));
        component.isAllChecked = false;
    ...
    it('Test if when blockOrders() res[0] == undefined, method changes values of isBlocked and isEditable', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        spyOn(service, 'blockOrders').and.returnValue(of(iAlertInfo));
        component.ordersToChange = [];
    ...
    it('Test if blockOrders() res[0] !== undefined method changes values of isBlocked and isEditable and calls showBlockedInfo ', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        spyOn(service, 'blockOrders').and.returnValue(of(iAlertInfo));
    ...
    it('Test changeData() calls editDateCell.emit() ', inject([AdminTableService], (service: AdminTableService) => {
  ...
  describe('@Input() properties testitg', () => {
    ...
    it('changeData() should set nameOfColumn to newValue field of iEditCell and call editDateCell.emit with it ', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        const spy = spyOn(component.editDateCell, 'emit');
        const dateEvent: any = { value: new Date() };
    ...
    it('changeData() should set id to id field of iEditCell and call editDateCell.emit with it ', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        const spy = spyOn(component.editDateCell, 'emit');
        const dateEvent: any = { value: new Date() };
    ...
    it('edit() should call blockOrders() with ordersToChange if ordersToChange.length > 0 ', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        spyOn(service, 'blockOrders').and.returnValue(of(iAlertInfo));
        component.isAllChecked = false;
    ...
    it('if isAllChecked == true and !ordersToChange.length, edit() should call blockOrders with [] ', inject(
      [AdminTableService],
      (service: AdminTableService) => {
        spyOn(service, 'blockOrders').and.returnValue(of(iAlertInfo));
        component.ordersToChange = [];
