...
import {
  ...
  HabitGiveUp,
  HabitLeavePage
} from 'src/app/greencity/modules/user/components/habit/models/habit-warnings';
import { WarningDialog } from 'src/app/greencity/modules/user/models/warning-dialog.inteface';
