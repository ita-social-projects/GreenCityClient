...
export class ChatsService {
  ...
  public getAllUserChats(userId: number): void {
    this.httpClient.get<Chat[]>(`${environment.backendLink}/chats/userId/${userId}`).subscribe((chats: Chat[]) => {
      console.log(chats);
  ...
  public updateChat(chat: Chat): void {
    this.httpClient.put<Chat>(`${environment.backendLink}/chats`, chat).subscribe();
  }
